    ...
    public partial class AgregarProductoForm : Form
    {
        ...
        private void BtnAgregar_Click(object sender, EventArgs e)
        {
            if (Validar())
            {
                ...
                ComiqueriaLogic.Entidades.ComiqueriaDAO.Insertar(nuevaDescripcion,nuevoPrecio,nuevoStock);

                //No se si también hay que agregarlo a la lista de la comiqueria
